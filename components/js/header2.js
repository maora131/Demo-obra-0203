      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            <li><a href="../../index.php" class="nav-link px-2 link-2">INICIO</a></li>
            <li><a href="../../citas/index.php" class="nav-link px-2 link-2">CITAS</a></li>
            <li><a href="../../persoas/index.php" class="nav-link px-2 link-2">PERSOAS</a></li>
            <li><a href="../../empresas/index.php" class="nav-link px-2 link-2">EMPRESAS</a></li>
            <li><a href="../../login/logout.php" class="nav-link px-2 link-2">SAÍR</a></li>
          </ul>
          ...
          <div class="dropdown text-end">
            ...
            <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
              ...
              <li><a class="dropdown-item" href="#">Saír</a></li>
            </ul>
          </div>
        </div>
      </div>
